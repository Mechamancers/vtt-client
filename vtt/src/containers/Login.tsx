    ...
    return(
        <div className='bg-rich-black h-[100svh] w-[100svw] flex justify-center items-center'>
            <div className='bg-blackish  w-[25rem] flex flex-col items-center px-4 py-10 rounded-lg'>
                <span className='block text-platinum pb-6'><GiMagicPortal style={{ fontSize: '2.5rem' }}/></span>
                <span className='block text-platinum font-title text-[1.3rem] font-bold pb-8'>Welcome to Mechamancers</span>
